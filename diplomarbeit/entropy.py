...
def calc_entropy():
    ...
    for grid, place in zip(gs0, ordered_list):
        ...
        ox.plot.plot_orientation(dict_Gu_street[place], ax=ax1, title='Straßen', area=True, title_font={'size':18}, title_y=1.1)
        ax2 = fig.add_subplot(gsi[1,1],projection='polar')
        ox.plot.plot_orientation(dict_Gu_tram[place], ax=ax2, title='Tram', area=True, color='r', title_font={'size':18}, title_y=1.1)
    ...
    fig.savefig(RESULTS_DIR / 'Orientations.png', dpi=300, bbox_inches='tight')
    ...
    #fig1.canvas.draw()
    fig1.savefig(RESULTS_DIR / 'Orientations1.pdf', dpi=300, bbox_inches='tight')
    fig1.savefig(RESULTS_DIR / 'Orientations1.png', dpi=300, bbox_inches='tight')
    plt.close(fig1)
    ...
    fig2.savefig(RESULTS_DIR / 'Orientations2.pdf', dpi=300, bbox_inches='tight')
    fig2.savefig(RESULTS_DIR / 'Orientations2.png', dpi=300, bbox_inches='tight')
    plt.close(fig2)
